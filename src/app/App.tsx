    ...
    <div className="App">
      <header className="App-header">
        ...
        <div>
          ...
          <div>
            Из последнего - участвовал в написании и запуске проекта для крупного турагентства на Laravel + VueJS,
            который сейчас в стадии поддержки.
          </div>
          <div>
            В данный момент возникла необходимость перенести часть проекта на React. Хочу познать его до мелочей :)
          </div>
        </div>
      </header>
    </div>
